...
\begin{verbatimwrite}{\econtexRoot/\TableDir/Comparison}
...
\multicolumn{1}{|c|}{\PFGIC} & \multicolumn{1}{c|}{\GIC} \\ \hline
...
\multirow{4}{75mm}{\thead{By Jensen's inequality, stronger than \\the \PFGIC. \\  Ensures consumers will not \\ expect to accumulate $\mRat$ unboundedly.}} \\
& \\
& \\
& \\
